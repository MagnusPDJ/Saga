...
{
    public class Staff : ItemBase, IWeapon, IEquipable, ITwoHanded, IPhysical
    {
            ...
            if (hasRight || hasLeft) {
                ...
                while (true) {
                    ...
                    if (input == "y") {
                        ...
                        Program.CurrentPlayer.Equipment[Slot.Left_Hand] = new Staff() { ItemName = ItemName, WeaponAttributes = { } };
