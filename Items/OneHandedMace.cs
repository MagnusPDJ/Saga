...
{
    [Discriminator("oneHandedMace")]
    public class OneHandedMace : IWeapon, IPhysical
    {
        ...
        public string Equip() {
            if (ItemLevel > Program.CurrentPlayer.Level) {
                ...
                Console.WriteLine($"Character can't equip a weapon of type one-handed mace, {ItemName}.");
                return "Weapon not equipped.";
            }
